...
var model = {
  ...
  "GTAV MENUS": {
	...
	"OTHER MENUS": {
      ...
      active: false,
      icon: "vibration",
      items: [{ title: "THE LAST OF US 1.08 DEBUG MENU", desc:"[L3+Touchpad(L)]=Quick Menu, [L3+Touchpad(R)]=Dev Menu, [L3+R3]=Fly", version: "2.0 by Vicodin10", active: false, icon: "accessibility", expage: "payloads/GTA/TLOUR.html" }, { title: "UNCHARTED 4 1.00/1.18/1.32 DEBUG MENU", desc:"[L3+Start]=Fav Menu, [L3+Touchpad(L)]=Quick Menu, [L3+Touchpad(R)]=Dev Menu, [L3+R3]=Fly", version: "2.0 by Vicodin10", active: false, icon: "exposure", expage: "payloads/GTA/UC4.html" }, { title: "UNCHARTED TLL 1.00 DEBUG MENU", desc:"[L3+Start]=Fav Menu, [L3+Touchpad(L)]=Quick Menu, [L3+Touchpad(R)]=Dev Menu, [L3+R3]=Fly", version: "2.0 by Vicodin10", active: false, icon: "motorcycle", expage: "payloads/GTA/UCTLL.html" } ]
	 },
	"LAN": {
      index: 10,
      title: "LAN",
	...
	"PKG": {
      ...
      active: false,
      icon: "weekend",
      items: [{ title: "HOST PKG", desc:"RPI-GUI install pkgs to your web browser for offline use", version: "WEB GUI by Sc0rpion 1.0 ", active: false, icon: "weekend", expage: "payloads/rpigui/RPILOADER.html" }]
	},
	"ARCADE": {
      index: 14,
      title: "ARCADE",
      ...
      active: false,
      icon: "cake",
      items: [{ title: "★WEBKIT 5.55", desc: "Quickly TEST WEBKIT", version:"BETA by 84Ciss", active: false, icon: "healing", expage: "payloads/5.55/5.55.html"  }]
	},
	"ABOUT": {
      index: 16,
      title: "ABOUT",
	...
	"★DEBUG": {
      ...
      active: false,
      icon: "cake",
      items: [{ title: "★PS4 Breacher", desc: "Quickly TEST WEBKIT", version:"BETA by 84Ciss", active: false, icon: "healing", expage: "payloads/test/6.00.html" }, { title: "[TEST KIT] SHOW MODE ON", desc:"Switches exhibition mode on", version: "1.0 by Zecoxao", active: false, icon: "error", expage: "payloads/showon.html" },{ title: "[TEST KIT] SHOW MODE OFF", desc:"Switches exhibition mode off", version: "1.0 by Zecoxao", active: false, icon: "error", expage: "payloads/showoff.html" }]
	},
  }
